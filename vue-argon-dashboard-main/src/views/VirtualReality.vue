<template>
  <div class="mt-3">
    <navbar :minNav="navbarMinimize" :toggle="toggleConfigurator" :class="`${this.$store.state.isNavFixed ? this.$store.state.navbarFixed_class : ''} ${this.$store.state.isNavFixed ? 'bg-white' : 'bg-success'}`
      " />
  </div>
